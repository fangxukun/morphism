...
import com.vdian.engine.function.BytesFunction;
import com.vdian.engine.function.DiscountYuanFunction;
import com.vdian.engine.function.PriceFunction;
import com.vdian.engine.function.ShieldFunction;
 ...
 * Time: 18:45
 * 通用的ValueSource扩展
 *  solrConfig: <valueSourceParser name="customParsers" class="com.vdian.engine.function.parser.ValueSourceParserBootStrap" />
 */
